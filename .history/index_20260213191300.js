...
window.addEventListener('resize', () => {
    ...
    if (width < 768) {
        // En celular: Tierra centrada y un poco más abajo
        globeGroup.position.x = 0;
        globeGroup.position.y = -0.5; // La bajamos para que no tape el perfil
        globeGroup.scale.set(0.8, 0.8, 0.8); // La achicamos un pelo
    } else {
        // En PC: Tierra a la derecha y centrada verticalmente
        globeGroup.position.x = 0.8;
...
// Llama al resize una vez al cargar para que aplique los cambios de inmediato
